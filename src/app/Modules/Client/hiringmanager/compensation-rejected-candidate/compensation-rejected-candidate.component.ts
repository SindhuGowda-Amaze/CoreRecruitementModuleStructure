...
@Component({
  selector: 'app-compensation-rejected-candidate',
  templateUrl: './compensation-rejected-candidate.component.html',
  styleUrls: ['./compensation-rejected-candidate.component.css']
})
export class CompensationRejectedCandidateComponent implements OnInit {
